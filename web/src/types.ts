...
export interface ComparisonRun { id: string; run_index: number; run_name: string; created_at: string; processing_duration_ms: number | null; processing_started_at: string | null; old_layout_name: string; new_layout_name: string; old_date_of_download: string | null; new_date_of_download: string | null; old_origin_file_name: string | null; new_origin_file_name: string | null; old_row_count: number | null; new_row_count: number | null; added: number; removed: number; modified: number; }
